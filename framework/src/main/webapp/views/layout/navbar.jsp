		...
		<ul class="nav ace-nav">
			...
			<li class="purple">
				...
				<ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
					...
					<li class="dropdown-content">
						<ul class="dropdown-menu dropdown-navbar navbar-pink">
								...
								<a href="#">
									<div class="clearfix">
										<span class="pull-left"> 
											<i class="btn btn-xs no-hover btn-pink fa fa-comment"></i> New Comments
										</span> 
							...
							<li><a href="#">
									<div class="clearfix">
										<span class="pull-left"> 
												<i class="btn btn-xs no-hover btn-success fa fa-shopping-cart"></i> New Orders
										</span> 
					...
					<li class="dropdown-footer">
						<a href="#"> See all notifications <i class="ace-icon fa fa-arrow-right"></i>
						</a>
					</li>
				</ul>
			</li>
						...
						<ul class="dropdown-menu dropdown-navbar">
							<li>
								<a href="#" class="clearfix"> 
									<img src="<%=assetsDir %>/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" /> 
									<span class="msg-body"> 
							...
							<li>
								<a href="#" class="clearfix">
									 <img src="<%=assetsDir %>/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
									 <span class="msg-body"> 
									  	<span class="msg-title"> 
							...
							<li>
								<a href="#" class="clearfix"> 
									<img src="<%=assetsDir %>/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" /> 
									<span class="msg-body"> 
										<span class="msg-title"> 
							...
							<li>
								<a href="#" class="clearfix"> 
									<img src="<%=assetsDir %>/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" /> 
									<span class="msg-body"> 
										<span class="msg-title"> 
							...
							<li>
								<a href="#" class="clearfix"> 
									<img src="<%=assetsDir %>/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" /> 
									<span class="msg-body"> 
										<span class="msg-title">
