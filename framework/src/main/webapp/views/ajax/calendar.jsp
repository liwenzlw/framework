...
<script type="text/javascript">
	var scripts = [null,"<%=assetsDir %>/js/jquery-ui.custom.js","<%=assetsDir %>/js/jquery.ui.touch-punch.js","<%=assetsDir %>/js/date-time/moment.js","<%=assetsDir %>/js/fullcalendar.js","<%=assetsDir %>/js/bootbox.js", null]
