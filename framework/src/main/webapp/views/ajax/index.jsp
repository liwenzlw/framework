	...
	<div class="col-xs-12">
		...
		<div class="alert alert-block alert-success">
			...
			<i class="ace-icon fa fa-check green"></i> Welcome to <strong
				class="green"> Ace <small>(v1.3.2)</small>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Bob Doe's avatar"
													src="<%=assetsDir %>/avatars/user.jpg" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Joe Doe's avatar"
													src="<%=assetsDir %>/avatars/avatar2.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Jim Doe's avatar"
													src="<%=assetsDir %>/avatars/avatar.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Alex Doe's avatar"
													src="<%=assetsDir %>/avatars/avatar5.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Susan's avatar"
													src="<%=assetsDir %>/avatars/avatar3.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Phil Doe's avatar"
													src="<%=assetsDir %>/avatars/avatar4.png" />
											</div>
										...
										<div class="itemdiv memberdiv">
											<div class="user">
												<img alt="Alexa Doe's avatar"
													src="<%=assetsDir %>/avatars/avatar1.png" />
											</div>
					...
					<div class="widget-body">
						<div class="widget-main no-padding">
							...
							<div class="dialogs">
								...
								<div class="itemdiv dialogdiv">
									<div class="user">
										<img alt="John's Avatar" src="<%=assetsDir %>/avatars/avatar.png" />
									</div>
								...
								<div class="itemdiv dialogdiv">
									<div class="user">
										<img alt="Bob's Avatar" src="<%=assetsDir %>/avatars/user.jpg" />
									</div>
								...
								<div class="itemdiv dialogdiv">
									<div class="user">
										<img alt="Jim's Avatar" src="<%=assetsDir %>/avatars/avatar4.png" />
									</div>
...
<!--[if lte IE 8]>
  <script src="<%=assetsDir %>/js/excanvas.js"></script>
<![endif]-->
<script type="text/javascript">
	var scripts = [ null, "<%=assetsDir %>/js/jquery-ui.custom.js",
			"<%=assetsDir %>/js/jquery.ui.touch-punch.js",
			"<%=assetsDir %>/js/jquery.easypiechart.js",
			"<%=assetsDir %>/js/jquery.sparkline.js",
			"<%=assetsDir %>/js/flot/jquery.flot.js",
			"<%=assetsDir %>/js/flot/jquery.flot.pie.js",
			"<%=assetsDir %>/js/flot/jquery.flot.resize.js", null ]
	$('.page-content-area')
			.ace_ajax(
					'loadScripts',
					scripts,
